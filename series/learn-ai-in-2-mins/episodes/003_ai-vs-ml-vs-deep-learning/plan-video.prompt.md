...
```
Plan the YouTube Short video for Episode 003: "AI vs Machine Learning vs Deep Learning"
...
cd remotion && npm run vtt -- 003_ai-vs-ml-vs-deep-learning

Confirm voiceover.vtt exists at:
series/learn-ai-in-2-mins/episodes/003_ai-vs-ml-vs-deep-learning/voiceover.vtt
...
series/learn-ai-in-2-mins/episodes/003_ai-vs-ml-vs-deep-learning/render-video.prompt.md

Use this structure (fill in all sections from your transcript-specific plan):

# Render Video — Episode 003: AI vs Machine Learning vs Deep Learning (generated from your recording)
...
1. cd remotion && node scripts/apply-vtt-to-episode.mjs 003_ai-vs-ml-vs-deep-learning
2. Update episode.yaml VISUAL FIELDS ONLY per the visual brief (steps, icons, headlines, callout — not voiceover text)
3. npm run video:003 from repo root
4. Confirm voiceover.vtt and remotion/out/003_ai-vs-ml-vs-deep-learning.mp4 exist

Reference template: series/learn-ai-in-2-mins/templates/render-video.prompt.template.md

## Do NOT in this session
- Do NOT modify episode.yaml
- Do NOT run npm run video:003 or render
