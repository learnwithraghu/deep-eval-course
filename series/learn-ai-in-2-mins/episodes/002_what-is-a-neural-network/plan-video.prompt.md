...
```
Plan the YouTube Short video for Episode 002: "What is a Neural Network?"

My voiceover is ready at:
series/learn-ai-in-2-mins/episodes/002_what-is-a-neural-network/voiceover.mp3

## Step 1 — Transcribe

Transcribe my MP3 to VTT (accurate caption timing from my actual recording):

cd remotion && npm run vtt -- 002_what-is-a-neural-network

Confirm voiceover.vtt exists at:
series/learn-ai-in-2-mins/episodes/002_what-is-a-neural-network/voiceover.vtt
...
series/learn-ai-in-2-mins/episodes/002_what-is-a-neural-network/render-video.prompt.md
...
1. cd remotion && node scripts/apply-vtt-to-episode.mjs 002_what-is-a-neural-network
2. Update episode.yaml VISUAL FIELDS ONLY per the visual brief (steps, icons, headlines, callout — not voiceover text)
3. npm run video:002 from repo root
4. Confirm voiceover.vtt and remotion/out/002_what-is-a-neural-network.mp4 exist
