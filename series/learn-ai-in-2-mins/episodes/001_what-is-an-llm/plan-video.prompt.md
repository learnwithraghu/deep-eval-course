...
```
Plan the YouTube Short video for Episode 001: "What is an LLM?"
...
cd remotion && npm run vtt -- 001_what-is-an-llm

Confirm voiceover.vtt exists at:
series/learn-ai-in-2-mins/episodes/001_what-is-an-llm/voiceover.vtt
...
# Render Video — Episode 001: What is an LLM? (generated from your recording)
...
1. cd remotion && node scripts/apply-vtt-to-episode.mjs 001_what-is-an-llm
2. Update episode.yaml VISUAL FIELDS ONLY per the visual brief (steps, icons, headlines, callout — not voiceover text)
3. npm run video:001 from repo root
4. Confirm voiceover.vtt and remotion/out/001_what-is-an-llm.mp4 exist
...
- Do NOT run npm run video:001 or render
