...
```
Plan the YouTube Short video for Episode 010: "What is Supervised Learning?"

My voiceover is ready at:
series/learn-ai-in-2-mins/episodes/010_what-is-supervised-learning/voiceover.mp3

## Step 1 — Transcribe

Transcribe my MP3 to VTT (accurate caption timing from my actual recording):

cd remotion && npm run vtt -- 010_what-is-supervised-learning

Confirm voiceover.vtt exists at:
series/learn-ai-in-2-mins/episodes/010_what-is-supervised-learning/voiceover.vtt
...
series/learn-ai-in-2-mins/episodes/010_what-is-supervised-learning/render-video.prompt.md

Use this structure (fill in all sections from your transcript-specific plan):

# Render Video — Episode 010: What is Supervised Learning? (generated from your recording)
...
1. cd remotion && node scripts/apply-vtt-to-episode.mjs 010_what-is-supervised-learning
2. Update episode.yaml VISUAL FIELDS ONLY per the visual brief (steps, icons, headlines, callout — not voiceover text)
3. npm run video:010 from repo root
4. Confirm voiceover.vtt and remotion/out/010_what-is-supervised-learning.mp4 exist

Reference template: series/learn-ai-in-2-mins/templates/render-video.prompt.template.md

## Do NOT in this session
- Do NOT modify episode.yaml
- Do NOT run npm run video:010 or render
