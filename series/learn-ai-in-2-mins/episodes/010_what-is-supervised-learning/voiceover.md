# Episode 010 — What is Supervised Learning?
...
The most common way AI learns has a name — supervised learning. Here's what it means.
...
Supervised learning trains AI on input-label pairs — clear feedback makes it effective, but creating labels is costly. It's how most practical AI gets built.
...
Or skip AI planning and run: `npm run video:010` from repo root
