...
```
Plan the YouTube Short video for Episode 006: "What is a Token?"
...
cd remotion && npm run vtt -- 006_what-is-a-token

Confirm voiceover.vtt exists at:
series/learn-ai-in-2-mins/episodes/006_what-is-a-token/voiceover.vtt
...
series/learn-ai-in-2-mins/episodes/006_what-is-a-token/render-video.prompt.md

Use this structure (fill in all sections from your transcript-specific plan):

# Render Video — Episode 006: What is a Token? (generated from your recording)
