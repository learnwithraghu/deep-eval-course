...
Bad data, bad AI. Every model starts with a dataset. But what is one?
...
A dataset is the curated collection of examples AI learns from — quality, diversity, and proper train-test splits determine whether your model actually works.
...
Or skip AI planning and run: `npm run video:008` from repo root
