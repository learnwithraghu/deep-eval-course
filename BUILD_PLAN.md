...
- Commits so far: `8d8491e`..`1b005c0` on `main`. A fresh session should run `git log --oneline` to confirm this matches the repo's actual state before continuing, then proceed to Session 7.
