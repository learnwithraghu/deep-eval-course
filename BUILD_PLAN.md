...
- Commits so far: `8d8491e`..`3867838` on `main`. A fresh session should run `git log --oneline` to confirm this matches the repo's actual state before continuing, then proceed to Session 6.
